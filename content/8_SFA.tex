...
Produktionssystem bereitgestellt wird. Diese Flaschen werden anschließend befüllt und mit Deckeln verschlossen. Ein Problem trat jedoch auf, dass 
nicht genügend Flaschen nachgeliefert wurden. Beispielsweise konnten von zwölf angeforderten Flaschen nur neun ankommen, wodurch die Abfüllung anhielt 
und auf die Ankunft der noch fehlenden Flaschen wartete (siehe Abbildung \ref{fig:Abfüllung}).
...
Der Drehteller erkannte nach einem Neustart weiterhin, dass sich Flaschen an den einzelnen Positionen im Drehteller befanden. Dies führte dazu, dass der 
...
erhielt. Beispielsweise müssen an Position eins(siehe Abbildung \ref{fig:Abfüllung}) die Flaschen befüllt, an Position zwei(siehe Abbildung \ref{fig:Abfüllung}) die Deckel angefordert, an Position drei(siehe Abbildung \ref{fig:Abfüllung}) die Deckel verschraubt 
und an Position 4(siehe Abbildung \ref{fig:Abfüllung}) die RFID-Tags beschrieben werden. Ohne korrekte Zustandsinformationen konnte der Drehteller diese Aufgaben nicht ausführen, 
