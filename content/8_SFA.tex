...
nachbestellung->neuer kommunikationsbaustein und neue funktion zum nachbestellen (nicht vom hmi sonder durch kommunikation bottledata)
nachbestellen wenn kein deckel auf der flasche ist (baustein von nachbestellung mit statstaionsdata[8] und umformung als input) + flanke bei new order (flaschenanforderung) einführen
...
mit max und micha entscheidung
...
Neuer Pellet return neues Konzept für Rückführung und neuer code
